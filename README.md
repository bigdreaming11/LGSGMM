...
This repository provides the official code for a **two-stage multi-drone multi-target association framework**. The method is evaluated on the **MDMT dataset、M3Track dataset** and implemented based on **LightGlue** and **SuperGlue**.
